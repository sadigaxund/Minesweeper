...
public class Images {
    ...
    public static final String WIN_SCREEN = rootRepo + "//win_icon" + FORMAT;
    public static final String LOSE_SCREEN = rootRepo + "//lose_icon" + FORMAT;
    ...
    public static final String MINE_NOT = rootRepo + "//tiles//mine3" + FORMAT;
